...
{
    public partial class RESTThemeGraduatedSymbol : Page
    {
        ...
        public RESTThemeGraduatedSymbol()
        {
            InitializeComponent();
            ...
            _layer.Failed += RESTThemeGraduatedSymbol_Failed;
            this.Unloaded += RESTThemeGraduatedSymbol_Unloaded;
        }

        void RESTThemeGraduatedSymbol_Unloaded(object sender, RoutedEventArgs e)
        {
            _layer.Failed -= RESTThemeGraduatedSymbol_Failed;
            this.Unloaded -= RESTThemeGraduatedSymbol_Unloaded;
            MyMap.Dispose();
        ...
        async void RESTThemeGraduatedSymbol_Failed(object sender, LayerFailedEventArgs e)
        {
