...
namespace SuperMap.WinRT.Utilities
{
    ...
    internal static class DoubleUtil
    {
        ...
        /// <returns></returns>
        public static bool ValueCheck(double value)
        {
            if (double.IsNaN(value) || double.IsInfinity(value) || value == double.Epsilon ||
                value == double.MaxValue || value == double.MinValue)
            {
                return false;
            }
            else
