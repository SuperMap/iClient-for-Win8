...
{
    /// <summary>${utility_Extensions_Title}</summary>
    public static class Extensions
    {
        /// <summary>${utility_Extensions_method_ToPolylineElement_GeoLine_D}</summary>
        ...
        /// <summary>${utility_Extensions_method_ToGeoLine_D}</summary>
        ...
        /// <summary>${utility_Extensions_method_ToPolygonElement_GeoRegion_D}</summary>
        ...
        /// <summary>${utility_Extensions_method_ToGeoRegion_PolygonElement_D}</summary>
        ...
        /// <summary>${utility_Extensions_method_ToGeoRegion_Rectangle2D_D}</summary>
        ...
        /// <summary>${utility_Extensions_method_ToPolygonElement_Rectangle2D_D}</summary>
        ...
        /// <summary>${utility_Extensions_method_Contains_GeoRegion_double_double_D}</summary>
        /// <param name="region">${utility_Extensions_method_Contains_GeoRegion_double_double_param_region}</param>
        /// <param name="x">${utility_Extensions_method_Contains_GeoRegion_double_double_param_x}</param>
        /// <param name="y">${utility_Extensions_method_Contains_GeoRegion_double_double_param_y}</param>
        /// <returns>${utility_Extensions_method_Contains_GeoRegion_double_double_returns_D}</returns>
