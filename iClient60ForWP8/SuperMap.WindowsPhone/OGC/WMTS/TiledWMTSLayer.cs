...
namespace SuperMap.Web.Mapping
{
    ...
    public class TiledWMTSLayer : TiledCachedLayer
    {
        ...
        private void wmtsManager_ProcessComplated(object sender, ResultEventArgs<GetWMTSCapabilitiesResult> e)
        {
            Rectangle2D bbox;
            double[] resolutions;
            WMTSManagerResult result;
            if (e.Result != null)
            {
                result = e.Result as WMTSManagerResult;
        ...
        public override void Initialize()
        {
            ...
            if (enableGetCapabilities)
            {
                ...
                wmtsManager.ProcessCompleted += new EventHandler<ResultEventArgs<GetWMTSCapabilitiesResult>>(wmtsManager_ProcessComplated);
                wmtsManager.Failed += new EventHandler<FailedEventArgs>(wmtsManager_Failed);
            }
        ...
        private void wmtsManager_Failed(object sender, FailedEventArgs e)
        {
            this.OnFailed(e.Error.OtherMessage);
        }
        ...
        public override string GetTileUrl(int indexX, int indexY, int level)
        {
            ...
            {
                return string.Format(System.Globalization.CultureInfo.InvariantCulture,this.Url, tileMatrixs[level].Name, indexY, indexX);
            }
            else
            {
                ...
                {
                    return string.Format(System.Globalization.CultureInfo.InvariantCulture,this.Url, name, indexY, indexX);
                }
            }
