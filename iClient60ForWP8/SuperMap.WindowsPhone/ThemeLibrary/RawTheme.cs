...
{
    /// <summary>
    /// 	<para>${WP_core_RawTheme_Title}</para>
    /// 	<para>${WP_core_RawTheme_Description}</para>
    /// </summary>
    public class RawTheme : Theme
    {
        /// <summary>${WP_core_RawTheme_constructor_None_D}</summary>
        public RawTheme( )
        {
        ...
        /// <summary>${WP_core_Theme_attribute_FCGreen_D}</summary>
        public static Color FCGreen { get; set; }
        /// <summary>${WP_core_Theme_attribute_FCOrange_D}</summary>
        public static Color FCOrange { get; set; }
        /// <summary>${WP_core_Theme_attribute_FCBlue_D}</summary>
        public static Color FCBlue { get; set; }
        /// <summary>${WP_core_Theme_attribute_FCYollew_D}</summary>
