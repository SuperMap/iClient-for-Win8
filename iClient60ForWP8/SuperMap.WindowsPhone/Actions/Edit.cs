...
namespace SuperMap.WindowsPhone.Actions
{
    ...
    public class Edit : MapAction
    {
        ...
        private Point pointOffset;//用于编辑点时，鼠标位置相对于对象的偏移
        ...
        public override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (activeFeature!=null&&activeFeature.Geometry is GeoPoint)
            {
                MarkerStyle style = activeFeature.Style as MarkerStyle;
                p.X += pointOffset.X;
                p.Y += pointOffset.Y;
            }
            Point2D newPnt = Map.ScreenToMap(p);
    ...
    internal static class MouseExtensions
    {
        ...
        public static void AddDoubleClick(this Feature element , MouseButtonEventHandler handler)
        {
